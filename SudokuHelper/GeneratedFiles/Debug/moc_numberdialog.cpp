...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NumberDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 34, 22)
    ...
    "NumberDialog\0digitClicked\0\0button\0"
...
void *NumberDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Dialog"))
        return static_cast< Ui::Dialog*>(const_cast< NumberDialog*>(this));
